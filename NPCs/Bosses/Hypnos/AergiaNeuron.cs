...
namespace CalRemix.NPCs.Bosses.Hypnos
{
    internal class AergiaNeuron : ModNPC
    {
        ...
        public override void AI()
        {
			...
			//hypnos = Main.npc[CalRemixGlobalNPC.hypnos];
        ...
        public void doafterimages(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D glowmask = p2 ? ModContent.Request<Texture2D>("CalRemix/NPCs/Bosses/Hypnos/AergiaNeuron2_Glow").Value : ModContent.Request<Texture2D>("CalRemix/NPCs/Bosses/Hypnos/AergiaNeuron_Glow").Value;
            if (p2)
            {
                texture = ModContent.Request<Texture2D>("CalRemix/NPCs/Bosses/Hypnos/AergiaNeuron2").Value;
            }
        ...
        public void drawchain(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            bool doIDraw = true;
            Texture2D texture = Request<Texture2D>("CalRemix/NPCs/Bosses/Hypnos/HypnosPlugCable").Value; //change this accordingly to your chain texture
        ...
        public void DrawHypnos(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            if (NPC.ai[1] == 11)
            {
                ...
                Texture2D pipestexture = Request<Texture2D>("CalRemix/NPCs/Bosses/Hypnos/Hypnos_Pipes").Value;
