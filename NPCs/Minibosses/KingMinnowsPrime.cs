...
namespace CalRemix.NPCs.Minibosses
{
    public class KingMinnowsPrime : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (Main.dedServ)
                return;
            ScreenHelperMessageManager.LoadFannyMessage(new HelperMessage("KingMinnows",
        ...
        public override void SetDefaults()
        {
            ...
            NPC.DeathSound = new SoundStyle($"{nameof(CalRemix)}/Sounds/MinnowsSounds/MinnowsDeathScream");
