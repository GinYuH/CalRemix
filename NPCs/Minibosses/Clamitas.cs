...
namespace CalRemix.NPCs.Minibosses
{
    ...
    public class Clamitas : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D glow = ModContent.Request<Texture2D>($"{nameof(CalRemix)}/NPCs/Minibosses/Clamitas_Fire", AssetRequestMode.ImmediateLoad).Value;
        ...
        {
            Texture2D glow = ModContent.Request<Texture2D>($"{nameof(CalRemix)}/NPCs/Minibosses/Clamitas_Glow", AssetRequestMode.ImmediateLoad).Value;
