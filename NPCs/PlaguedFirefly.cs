...
namespace CalRemix.NPCs
{
    public class PlaguedFirefly : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRemix/NPCs/PlaguedFirefly_Aura").Value, drawPos, NPC.frame, new Color(255, 255, 255, 100), NPC.rotation, origin, NPC.scale, effects, 0f);
            return false;
        }
    }
}