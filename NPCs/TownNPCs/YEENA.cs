...
namespace CalRemix.NPCs.TownNPCs
{
    ...
    public class YEENA : ModNPC
    {
        ...
        public override bool CanTownNPCSpawn(int numNPCs)
        {
        ...
        public override void AddShops()
        {
            ...
            CalRemix.AddToShop(ModContent.ItemType<CalamityMod.Items.Potions.DeliciousMeat>(), Item.buyPrice(0, 0, 0, 20), ref shop);
            CalRemix.AddToShop(ModContent.ItemType<CalamityMod.Items.TreasureBags.CryogenBag>(), Item.buyPrice(0, 50), ref shop);
            shop.Register();
