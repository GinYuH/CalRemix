...
using static CalRemix.Core.AdditiveDifficultyModeSystem;
using static Terraria.GameContent.FontAssets;

namespace CalRemix.UI.ModeIndicatorAdditive
{
    public class ModeIndicatorAdditiveUI
    {
        ...
        public static Vector2 DrawCenter => new Vector2(Main.screenWidth - 500f - WidthForTier(MostAlternateDifficulties) * 0.5f, 82f) + FrameSize * 0.5f;
        ...
        private static AdditiveDifficultyMode previouslyHoveredMode = null;
        ...
        public static void ManageHexIcons(SpriteBatch spriteBatch, out string text)
        {
            ...
            for (int i = 0; i < tiers; i++)
            {
                ...
                {
                    AdditiveDifficultyMode mode = DifficultyTiers[i][j];
        ...
        public static string GetDifficultyText(AdditiveDifficultyMode mode)
        {
        ...
        public static void SwitchToDifficulty(AdditiveDifficultyMode mode)
        {
        ...
        internal class ModeIndicatorAdditiveUISystem : ModSystem
        {
            ...
            public override void ModifyInterfaceLayers(List<GameInterfaceLayer> layers)
            {
                ...
                if (mouseIndex != -1)
                {
                    ...
                    {
                        ModeIndicatorAdditiveUI.Draw(Main.spriteBatch);
                        return true;
