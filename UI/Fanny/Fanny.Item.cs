...
namespace CalRemix.UI
{
    public partial class ScreenHelperManager : ModSystem
    {
        ...
        {
            #region Item
            screenHelperMessages.Add(new HelperMessage("Forge", "Na Na Na! The big robotic forge needs a lot of blue meat from the ads! It cannot work without it!",
            ...
            screenHelperMessages.Add(new HelperMessage("DeliciousMeat", "Oooh! Delicious Meat! Collect as much as you can, it will save you a lot of time.", "FannyAwooga",
            ...
            screenHelperMessages.Add(new HelperMessage("Relocator", "Wow! You crafted a Normality Relocator! with a press of a button, unyielding discord is at your fingertips!", "FannyIdle",
            ...
            screenHelperMessages.Add(new HelperMessage("BunnyMurder", "...",
            ...
            screenHelperMessages.Add(new HelperMessage("Diamond", "Did you know that the largest diamond ever found was 3106.75 carats?",
            ...
            screenHelperMessages.Add(new HelperMessage("Terraspark", "New shoes!!!",
            ...
            screenHelperMessages.Add(new HelperMessage("RoxcaliburShimmer", "Woah, something about that doesn't seem right! I'll take those off your hands- wouldn't wanna skip stuff, would you?",
            ...
            screenHelperMessages.Add(new HelperMessage("VoodooDoll", "Cool doll you have! I think that it will be even cooler when in lava!",
                "FannyAwooga", (ScreenHelperSceneMetrics scene) => Main.LocalPlayer.HasItem(ItemID.GuideVoodooDoll)));

            screenHelperMessages.Add(new HelperMessage("TwentyTwo", "I love 22. My banner now.",
            ...
            screenHelperMessages.Add(new HelperMessage("Shadowspec", "Please throw this thing out, it will delete your world if you have it in inventory for too long!",
            ...
            screenHelperMessages.Add(new HelperMessage("Wood", "Wood? Yummy!",
              "FannyAwooga", (ScreenHelperSceneMetrics scene) => Main.LocalPlayer.HasItem(ItemID.Wood)));

            screenHelperMessages.Add(new HelperMessage("HallowedBar", "What you hold now is a bar of extraordinary power infused with the essence of Heaven itself! That's a biome right?",
            ...
            screenHelperMessages.Add(new HelperMessage("LifeCrystal", "Ah, digging up life crystals, are we? Remember, a crystal a day keeps the.. uhh... enemies away! See, I'm good with rhymes!",
               "FannyIdle", (ScreenHelperSceneMetrics scene) => Main.LocalPlayer.HasItem(ItemID.LifeCrystal)));

            screenHelperMessages.Add(new HelperMessage("YharimBar", "Is that a Yharim Bar? You'll need a lot of them for various recipes!",
            ...
            screenHelperMessages.Add(new HelperMessage("Jump", "Did you know? You can press the \"space\" button to jump!",
            ...
            screenHelperMessages.Add(new HelperMessage("TitanHeart", "You got a heart from a titan! Place it on the tower for a wacky light show!",
            ...
            screenHelperMessages.Add(new HelperMessage("BloodyVein", "The Bloody Vein is an item of utmost importance which can be inserted into various altars and machinery for wacky results. How about inserting one into one of those lab hologram box things?",
            ...
            screenHelperMessages.Add(new HelperMessage("RottenEye", "The Rotting Eyeball is an item of zero importance. The Bloody Vein from the Crimson's Perforators is way better!",
            ...
            screenHelperMessages.Add(new HelperMessage("AlloyBar", "Congratulations, you have obtained the final bar for this stage of your adventure. You should attempt making some Alloy Bars, a versatile material made of every available bar which can be used for powerful items.",
            ...
            screenHelperMessages.Add(new HelperMessage("Sponge", "Oh, is that a Sponge? Maybe avoid using it. I've heard something about the wielder dying, or something...",
            ...
            screenHelperMessages.Add(new HelperMessage("Garbo", "Wowie! That scrap there is useless!",
            ...
            screenHelperMessages.Add(new HelperMessage("Nightfuel", "Nightmare Fuel, huh? ...you know, maybe if you can harvest enough of it, maybe those Pumpkings will stop terorrizing our inhabitants and they'll be permanently more happy!",
            ...
            screenHelperMessages.Add(new HelperMessage("Endenergy", "Ooh, is that Endothermic Energy? If we can get a decent supply of it, I think those Ice Queens will fear us and our residents might be forever grateful with us!",
            ...
            screenHelperMessages.Add(new HelperMessage("Darksunfrag", "What's that? Darksun Fragment? Do you think with enough of it, our world will be permanently lit up like a lemon-scented candle flame?",
            ...
            screenHelperMessages.Add(new HelperMessage("Onion", "I'd be weary about eating that strange plant. You can only get one, so it might be useful to hang on to it for later.",
            ...
            screenHelperMessages.Add(new HelperMessage("CleavageFurrow", "One time, I went to the pond on a bright summer afternoon! One of the frogs leaped from its lily pad and locked eyes with me. I believe it had a cleavage furrow? Oh, what a dopey little smile that fella had!",
            ...
            screenHelperMessages.Add(new HelperMessage("PetRock", "Oh hey, is that my pet rock? I lost it in my backyard a few years back. I’ve been trying to find it since!",
            ...
            screenHelperMessages.Add(new HelperMessage("ThoriumOre", "Hey, take a look at this blueish-greenish-yellow metal! Isn't it cool? It's called Thorium! That would be a great name for a mod! Thankfully, we're not in a game, so I can use it freely!",
               "FannyNuhuh", (ScreenHelperSceneMetrics scene) => CalRemixHelper.HasCrossModItem(Main.LocalPlayer, "ThoriumMod", "ThoriumOre")));

            screenHelperMessages.Add(new HelperMessage("OcramSkull", "Woah! That skull looks a bit.. off! I feel like i've seen it before, a long time ago. I'm pretty sure it summons a really big bad guy! Are you sure you can take him? (He's really big, and bad!)",
            ...
            screenHelperMessages.Add(new HelperMessage("BloodGod", "I remember the Blood God, he was very friendly! Too bad he was kicked back into something called \"FertyKay\".",
                "FannySob", (ScreenHelperSceneMetrics scene) => Main.LocalPlayer.HasItem(ModContent.ItemType<ChaliceOfTheBloodGod>())));

            screenHelperMessages.Add(new HelperMessage("Murasama", "Erm, holy crap? $0? Is that a reference to my FAVORITE game of all time, Final Fantasy? Did you know that calamity adds a custom boss health boss bar and many othe-",
