...
namespace CalRemix.UI
{
    public partial class ScreenHelperManager : ModSystem
    {
        ...
        {
            #region Weapon
            HelperMessage.New("Murasama", "Erm, holy crap? $0? Is that a reference to my FAVORITE game of all time, metal gear rising revengeance? Did you know that calamity adds a custom boss health boss bar and many othe-",
