    ...
    public partial class ScreenHelperManager : ModSystem
    {
        ...
        public static void LoadCrimSon()
        {
            ...
            HelperMessage.New("CrimMedicalAid", "Give me Painkillers.",
                "CrimSonDefault", (ScreenHelperSceneMetrics metrics) => Main.LocalPlayer.inventory.Any((Item i) => medicalItems.Contains(i.type)), onlyPlayOnce: false).AddStartEvent(GetMedicalHelp).SpokenByAnotherHelper(ScreenHelpersUIState.CrimSon);
