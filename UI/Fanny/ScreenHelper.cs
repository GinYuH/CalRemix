    ...
    public class ScreenHelpersUIState : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            LoadScreenHelper(CrimSon, "CrimSonDefault")
                ...
                .SetAvailabilityCondition(() => (Main.LocalPlayer.GetModPlayer<CalRemixPlayer>().gottenCellPhone || NPC.downedGolemBoss || (!CalRemixWorld.postGenUpdate && !SubworldSystem.AnyActive())) && Main.hardMode && (DateTime.Today.DayOfYear != 18))
