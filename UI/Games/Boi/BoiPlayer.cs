...
namespace CalRemix.UI.Games.Boi.BaseClasses
{
    public class BoiPlayer : BoiEntity, IDamageable, IColliding, IDrawable
    {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 offset)
        {
            ...
            Texture2D Anahita = ModContent.Request<Texture2D>("CalRemix/UI/Games/Boi/Anahita").Value;
            Texture2D Shadow = ModContent.Request<Texture2D>("CalRemix/UI/Games/Boi/AnahitaShadow").Value;
