    ...
    internal class CalRemixHooks : ModSystem
    {
        ...
        */
        ...
        public static void FreezeIcon(Terraria.UI.On_UIElement.orig_Draw orig, UIElement self, SpriteBatch spriteBatch)
        {
            ...
            if (wid < 500 && !((self is Fanny || self is FannyTextbox) && !FannyManager.fannyEnabled) && (CalRemix.CalVal != null && self.GetType() != CalRemix.calvalFanny && self.GetType() != CalRemix.calvalFannyBox))
            {
