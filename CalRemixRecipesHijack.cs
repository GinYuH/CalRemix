...
namespace CalRemix
{
    public partial class Recipes
    {
        ...
        public override void Load()
        {
            ...
            essenceBarCrafts.Add((ItemType<TheAbsorber>(), ItemType<EssentialEssenceBar>(), 10));
            essenceBarCrafts.Add((ItemType<AmbrosialAmpoule>(), ItemType<EssentialEssenceBar>(), 5));
            essenceBarCrafts.Add((ItemType<AbyssalDivingSuit>(), ItemType<EssentialEssenceBar>(), 25));
            essenceBarCrafts.Add((ItemType<AbyssalDivingGear>(), ItemType<EssentialEssenceBar>(), 5));
            essenceBarCrafts.Add((ItemType<CosmicAnvilItem>(), ItemType<EssentialEssenceBar>(), 20));
            essenceBarCrafts.Add((ItemType<CosmicWorm>(), ItemType<EssentialEssenceBar>(), 20));
            essenceBarCrafts.Add((ItemType<AbyssBlade>(), ItemType<EssentialEssenceBar>(), 5));
            ...
            essenceBarCrafts.Add((ItemType<Confection>(), ItemType<EssentialEssenceBar>(), 20));
            essenceBarCrafts.Add((ItemType<AstrealDefeat>(), ItemType<EssentialEssenceBar>(), 25));
            essenceBarCrafts.Add((ItemType<ClockworkBow>(), ItemType<EssentialEssenceBar>(), 30));
            essenceBarCrafts.Add((ItemType<CosmicRainbow>(), ItemType<EssentialEssenceBar>(), 10));
            essenceBarCrafts.Add((ItemType<Abombination>(), ItemType<EssentialEssenceBar>(), 2));
            essenceBarCrafts.Add((ItemType<AbyssalMirror>(), ItemType<EssentialEssenceBar>(), 20));
            ...
            essenceBarCrafts.Add((ItemType<TrueArkoftheAncients>(), ItemType<EssentialEssenceBar>(), 15));
            essenceBarCrafts.Add((ItemType<AsgardsValor>(), ItemType<EssentialEssenceBar>(), 5));
            essenceBarCrafts.Add((ItemType<TrueBiomeBlade>(), ItemType<EssentialEssenceBar>(), 7));
            essenceBarCrafts.Add((ItemType<BarracudaGun>(), ItemType<EssentialEssenceBar>(), 5));
            essenceBarCrafts.Add((ItemType<BladedgeRailbow>(), ItemType<EssentialEssenceBar>(), 3));
            essenceBarCrafts.Add((ItemType<BrimstoneSword>(), ItemType<EssentialEssenceBar>(), 3));
            essenceBarCrafts.Add((ItemType<CatastropheClaymore>(), ItemType<EssentialEssenceBar>(), 6));
            essenceBarCrafts.Add((ItemType<DarklightGreatsword>(), ItemType<EssentialEssenceBar>(), 4));
            essenceBarCrafts.Add((ItemType<FlarefrostBlade>(), ItemType<EssentialEssenceBar>(), 5));
            #endregion
            #region Yharim Bars
