...
{
    public class ExtensionCordWhip : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                Rectangle frame = new Rectangle(0, 0, 18, 58); // The size of the Handle (measured in pixels)
                Vector2 origin = new Vector2(9, 12); // Offset for where the player's hand will start measured from the top left of the image.
                float scale = 1;
                ...
                if (i == list.Count - 2)
                {
                    ...
                    frame.Y = 216; // Distance from the top of the sprite to the start of the frame.
