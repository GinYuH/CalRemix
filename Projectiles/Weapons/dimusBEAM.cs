...
public class dimusBEAM : BaseLaserbeamProjectile //I can't believe Jharim would use a base projectile from Calamity, literal thievery! ban!!!!
{
    ...
    public override string Texture => "CalRemix/Projectiles/Weapons/dimusBEAM";
    ...
    public override Texture2D LaserBeginTexture => ModContent.Request<Texture2D>("CalRemix/Projectiles/Weapons/dimusBEAMstart", AssetRequestMode.ImmediateLoad).Value;
    public override Texture2D LaserMiddleTexture => ModContent.Request<Texture2D>("CalRemix/Projectiles/Weapons/dimusBEAM", AssetRequestMode.ImmediateLoad).Value;
    public override Texture2D LaserEndTexture => ModContent.Request<Texture2D>("CalRemix/Projectiles/Weapons/dimusBEAMend", AssetRequestMode.ImmediateLoad).Value;
