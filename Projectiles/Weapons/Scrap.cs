...
namespace CalRemix.Projectiles.Weapons
{
    ...
    {
        public override string Texture => "CalRemix/Projectiles/Weapons/Scrap1";
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("CalRemix/Projectiles/Weapons/Scrap" + Projectile.ai[0]).Value;
