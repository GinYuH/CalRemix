...
namespace CalRemix.Core.Scenes
{
    ...
    public class PandemicSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            {
                BloodCell c = cells[i];
                Texture2D cell = c.variant ? ModContent.Request<Texture2D>("CalRemix/Content/NPCs/PandemicPanic/RedBloodCell").Value : ModContent.Request<Texture2D>("CalRemix/Content/NPCs/PandemicPanic/RedBloodCell2").Value;
