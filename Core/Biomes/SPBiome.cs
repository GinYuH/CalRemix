...
namespace CalRemix.Core.Biomes
{
    ...
    public class SPBiome : ModBiome
    {
        ...
        public override Color? BackgroundColor => Color.LightSeaGreen;
        ...
        {
            return SubworldSystem.IsActive<SingularPointSubworld>();
        }
        ...
        public override ModWaterStyle WaterStyle => ModContent.Find<ModWaterStyle>("CalRemix/SPWater");
    }
}