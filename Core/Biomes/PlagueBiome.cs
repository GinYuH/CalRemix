...
namespace CalRemix.Core.Biomes
{
    ...
    public class PlagueBiome : ModBiome
	{
        ...
        public override void SpecialVisuals(Player player, bool isActive)
        {
			...
			ReLogic.Content.Asset<Texture2D> newrain = ModContent.Request<Texture2D>("CalRemix/Content/Waters/PlagueRain");
            ReLogic.Content.Asset<Texture2D> ograin = ModContent.Request<Texture2D>("CalRemix/Content/Waters/RainOriginal");
            if (Main.bloodMoon)
