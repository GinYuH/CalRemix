...
namespace CalRemix.Core.Biomes
{
    ...
    public class GreatSeaWorldBiome : ModBiome
    {
        ...
        public override string BestiaryIcon => "CalRemix/Core/Biomes/GreatSeaWorldIcon";
        ...
        {
            return SubworldSystem.IsActive<GreatSeaSubworld>();
        }
