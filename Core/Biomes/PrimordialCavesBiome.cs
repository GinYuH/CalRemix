...
namespace CalRemix.Core.Biomes
{
    ...
    public class PrimordialCavesBiome : ModBiome
    {
        ...
        public override ModWaterStyle WaterStyle => WaterStyleID.Cavern;
        ...
        {
            return SubworldSystem.IsActive<GrandSeaSubworld>() && player.position.Y > GrandSeaGeneration.groundBottom * Main.maxTilesY * 16;
        }
