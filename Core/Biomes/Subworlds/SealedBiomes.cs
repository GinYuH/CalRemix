...
namespace CalRemix.Core.Biomes
{
    public class SealedFieldsBiome : ModBiome
    {
        ...
        {
            return SubworldSystem.IsActive<SealedSubworld>() && CalRemixWorld.sealedTiles > 200 && (CalRemixWorld.barrenTiles + CalRemixWorld.carnelianTiles + CalRemixWorld.darnwoodTiles + CalRemixWorld.badTiles + CalRemixWorld.turnipTiles) < 50;
        }
