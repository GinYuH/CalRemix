...
namespace CalRemix.Core.Subworlds
{
    public class PinnaclesSubworld : Subworld, IDisableOcean, ICustomSpawnSubworld, IFixDrawBlack
    {
        ...
        public List<(int, float, Predicate<NPCSpawnInfo>)> Spawns()
        {
            ...
            list.Add(item: (ModContent.NPCType<Bloudirenosium>(), 3, n => NPC.CountNPCS(ModContent.NPCType<Bloudirenosium>()) < 4 && Main.tile[n.SpawnTileX, n.SpawnTileY + 1].HasTile && n.SpawnTileY > Main.maxTilesY * 0.8f));
            list.Add(item: (ModContent.NPCType<Gerasimekon>(), 0.01f, n => !Main.tile[n.SpawnTileX, n.SpawnTileY + 1].HasTile && n.SpawnTileY < Main.maxTilesY * 0.8f && n.SpawnTileX > Main.maxTilesX * 0.2f));
            list.Add(item: (ModContent.NPCType<Vinisunik>(), 10, n => Main.tile[n.SpawnTileX, n.SpawnTileY + 1].HasTile));
            return list;
        }
