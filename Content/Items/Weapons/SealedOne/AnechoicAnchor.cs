...
namespace CalRemix.Content.Items.Weapons.SealedOne
{
	public class AnechoicAnchor : ModItem
	{
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<AnechoicAnchorProjectile>();
    ...
    public class AnechoicAnchorProjectile : ModProjectile
    {
        // The folder path to the flail chain sprite
        private const string ChainTexturePath = "CalRemix/Content/Items/Weapons/SealedOne/AnechoicAnchorProjectile_Chain";
