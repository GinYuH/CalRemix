...
{
    public class HataqausLashes : ModItem
    {
        public override void SetDefaults()
        {
            Item.DefaultToWhip(ModContent.ProjectileType<HataqausLashesProj>(), 131, 2, 16);
        ...
        {
            CreateRecipe().
                AddIngredient(ModContent.ItemType<SealedLashes>()).
                AddIngredient(ModContent.ItemType<VoidSingularity>()).
                AddIngredient(ModContent.ItemType<WaterMesh>(), 8).
