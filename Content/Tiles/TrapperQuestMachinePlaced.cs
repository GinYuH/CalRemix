...
{
    public class TrapperQuestMachinePlaced : ModTile
    {
        public override string Texture => "CalRemix/Content/Tiles/BoiMachinePlaced";
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            localPlayer.cursorItemIconID = ModContent.ItemType<TrapperQuestMachine>();
        }
    }
}