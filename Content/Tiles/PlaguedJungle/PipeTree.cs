...
namespace CalRemix.Content.Tiles.PlaguedJungle
{
	public class PipeTree : ModTree
    {
        ...
        public override Asset<Texture2D> GetTopTextures() => ModContent.Request<Texture2D>("CalRemix/Content/Tiles/PlaguedJungle/PipeTreeTops");
        ...
        public override Asset<Texture2D> GetBranchTextures() => ModContent.Request<Texture2D>("CalRemix/Content/Tiles/PlaguedJungle/PipeTreeBranch");
        public override Asset<Texture2D> GetTexture() => ModContent.Request<Texture2D>("CalRemix/Content/Tiles/PlaguedJungle/PipeTree");
