...
{/*Blocks*/
    public class PlaguedGrass : ModTile
	{
		...
		{
			Dust.NewDust(new Vector2((float)i, (float)j) * 16f, 16, 16, DustID.BubbleBurst_Green, 0f, 0f, 1, new Color(255, 255, 255));
			return false;
		}
	...
	public class PlaguedHive : ModTile
	{
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			if (tile.Slope == 0 && !tile.IsHalfBlock)
			{
				...
				Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRemix/Content/Tiles/PlaguedJungle/PlaguedHiveGlow").Value,
