...
{
    public class VoidMetaballYellow : Metaball
    {
        public class VoidParticleYellow
        {
            public float Size;
            ...
            public VoidParticleYellow(Vector2 center, Vector2 velocity, float size, int boundNPC = -1)
            {
                Center = center;
                Velocity = velocity;
                Size = size;
        ...
        public static List<VoidParticleYellow> Particles
        {
            get;
            private set;
        } = new();
        ...
        public override bool AnythingToDraw => Particles.Any() || NPC.AnyNPCs(ModContent.NPCType<ShadeYellow>());
        ...
        public override Color EdgeColor => new(255, 255, 0);
        ...
        public override void Load()
        {
            ...
            // Load layer assets.
            layerAssets = new() { ModContent.Request<Texture2D>("CalRemix/Assets/ExtraTextures/VoidMetaballYellow", AssetRequestMode.ImmediateLoad) };
        }
        ...
        {
            return ShadeYellow.texOffsetYellow;
        }
        ...
        public override void DrawInstances()
        {
            ...
            // Draw all particles.
            foreach (VoidParticleYellow particle in Particles)
            {
            ...
            int voidType = ModContent.NPCType<ShadeYellow>();
