...
{
    public class VoidMetaballGreen : Metaball
    {
        public class VoidParticleGreen
        {
            public float Size;
            ...
            public VoidParticleGreen(Vector2 center, Vector2 velocity, float size, int boundNPC = -1)
            {
                Center = center;
                Velocity = velocity;
                Size = size;
        ...
        public static List<VoidParticleGreen> Particles
        {
            get;
            private set;
        } = new();
        ...
        public override bool AnythingToDraw => Particles.Any() || NPC.AnyNPCs(ModContent.NPCType<ShadeGreen>());
        ...
        public override Color EdgeColor => new(34, 177, 76);
        ...
        public override void Load()
        {
            ...
            // Load layer assets.
            layerAssets = new() { ModContent.Request<Texture2D>("CalRemix/Assets/ExtraTextures/VoidMetaballGreen", AssetRequestMode.ImmediateLoad) };
        }
        ...
        public override void DrawInstances()
        {
            ...
            // Draw all particles.
            foreach (VoidParticleGreen particle in Particles)
            {
            ...
            int voidType = ModContent.NPCType<ShadeGreen>();
