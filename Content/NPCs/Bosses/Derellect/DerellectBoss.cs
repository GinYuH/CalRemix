...
namespace CalRemix.Content.NPCs.Bosses.Derellect
{
    [AutoloadBossHead]
       ...
       public void ChangePhase(int phasenum, bool reset1 = true, bool reset2 = true, bool reset3 = true)
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            if (NPC.IsABestiaryIconDummy)
            {
                ...
                Texture2D glowmask = Request<Texture2D>("CalRemix/Content/NPCs/Bosses/Derellect/DerellectGlow").Value;
