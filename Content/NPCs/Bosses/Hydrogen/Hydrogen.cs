...
namespace CalRemix.Content.NPCs.Bosses.Hydrogen
{
    ...
    public class Hydrogen : ModNPC
    {
        ...
        public static readonly SoundStyle HitSound = new("CalRemix/Assets/Sounds/GenBosses/HydrogenHit", 4);
        public static readonly SoundStyle ExplosionSound = new("CalRemix/Assets/Sounds/GenBosses/HydrogenExplode");
        public static readonly SoundStyle BeepSound = new("CalRemix/Assets/Sounds/GenBosses/HydrogenBeep");
