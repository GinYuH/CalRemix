...
namespace CalRemix.Content.NPCs.PandemicPanic
{
    public class PandemicPanic : ModSystem
    {
        ...
        public static void StartEvent()
        {
            ...
            CalRemixHelper.BroadcastLocalizedText("Mods.CalRemix.StatusText.PandemicPanicBegin", Color.Red);
        }
        ...
        public static void EndEvent()
        {
            ...
            CalRemixHelper.BroadcastLocalizedText("Mods.CalRemix.StatusText.PandemicPanic" + winner, c);
