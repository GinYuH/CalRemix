...
{
    public abstract class MinecraftArrow : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] % 2 == 0 && Projectile.ai[0] > 1)
                GeneralParticleHandler.SpawnParticle(new HealingPlus(Projectile.Center, 0.6f, Projectile.velocity.SafeNormalize(Vector2.UnitY) * 2, Color.LightPink, Color.DeepPink, 20));
        }
