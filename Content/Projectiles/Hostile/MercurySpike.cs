...
namespace CalRemix.Content.Projectiles.Hostile
{
    public class MercurySpike : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.Center = Vector2.Lerp(start, start + Projectile.rotation.ToRotationVector2().RotatedBy(MathHelper.PiOver2) * 1000, CalamityUtils.ExpInEasing(Utils.GetLerpValue(startShoot, endShoot, Projectile.ai[1], true), 1));
            }
