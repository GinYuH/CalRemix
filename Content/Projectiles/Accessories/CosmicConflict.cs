...
namespace CalRemix.Content.Projectiles.Accessories
{
    public class CosmicConflict : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Player player = Main.player[Projectile.owner];
            deusheadsprite = (ModContent.Request<Texture2D>("CalRemix/Content/Projectiles/Accessories/EarthElementalArm").Value);
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                {
                    case 0:
                        deusheadsprite = (ModContent.Request<Texture2D>("CalRemix/Content/Projectiles/Accessories/CosmicCrystal_Air").Value);
                        ...
                        break;
                    case 1:
                        deusheadsprite = (ModContent.Request<Texture2D>("CalRemix/Content/Projectiles/Accessories/CosmicCrystal_Ice").Value);
                        ...
                        break;
                    case 2:
                        deusheadsprite = (ModContent.Request<Texture2D>("CalRemix/Content/Projectiles/Accessories/CosmicCrystal_Earth").Value);
                        size = 1.25f;
                        break;
                    case 3:
                        deusheadsprite = (ModContent.Request<Texture2D>("CalRemix/Content/Projectiles/Accessories/CosmicCrystal_Fire").Value);
                        ...
                        break;
                    case 4:
                        deusheadsprite = (ModContent.Request<Texture2D>("CalRemix/Content/Projectiles/Accessories/CosmicCrystal_Nature").Value);
