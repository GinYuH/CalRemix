    ...
    public class CosmicGuardianTail : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.netMode != NetmodeID.Server)
            {
                ...
                Gore.NewGore(Projectile.GetSource_Death(), Projectile.position, Projectile.velocity * randomSpread * Main.rand.NextFloat(), CalRemix.CalMod.Find<ModGore>("DoT2").Type, 1f);
                Gore.NewGore(Projectile.GetSource_Death(), Projectile.position, Projectile.velocity * randomSpread * Main.rand.NextFloat(), CalRemix.CalMod.Find<ModGore>("DoT3").Type, 1f);
                Gore.NewGore(Projectile.GetSource_Death(), Projectile.position, Projectile.velocity * randomSpread * Main.rand.NextFloat(), CalRemix.CalMod.Find<ModGore>("DoT4").Type, 1f);
                Gore.NewGore(Projectile.GetSource_Death(), Projectile.position, Projectile.velocity * randomSpread * Main.rand.NextFloat(), CalRemix.CalMod.Find<ModGore>("DoT5").Type, 1f);
            }
        }
