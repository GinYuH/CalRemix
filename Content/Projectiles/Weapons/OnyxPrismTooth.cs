...
{
    public class OnyxPrismTooth : ModProjectile
    {
        ...
        internal float WidthFunction(float completionRatio, Vector2 v) => Projectile.scale * 24f * (1f - Utils.GetLerpValue(0.7f, 1f, completionRatio, true)) + 1f;
