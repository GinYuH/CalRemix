...
{
    public class GildedGauntletProj : ModProjectile
    {
        public override string Texture => "CalRemix/Content/Items/Weapons/GildedGauntlet";
        ...
        public override void AI()
        {
            if (Projectile.velocity.Length() >= 4f)
            {
                for (int i = 0; i < 2; i++)
                {
                    ...
                    int smok = Dust.NewDust(new Vector2(Projectile.position.X + 3f + dustyX, Projectile.position.Y + 3f + dustyY) - Projectile.velocity * 0.5f, Projectile.width - 8, Projectile.height - 8, DustID.Smoke, 0f, 0f, 100, default, 0.5f);
            ...
            {
                int fieryDust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Smoke, 0f, 0f, 100, default, 0.5f);
                ...
                Main.rand.Next(2);
                fieryDust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Smoke, 0f, 0f, 100, default, 0.5f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int j = 0; j < 40; j++)
            {
                int boomDust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Smoke, 0f, 0f, 100, default, 1f);
            ...
            for (int k = 0; k < 70; k++)
            {
                int boomDust2 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Smoke, 0f, 0f, 100, default, 2f);
                Main.dust[boomDust2].noGravity = true;
                Main.dust[boomDust2].velocity *= 5f;
                boomDust2 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Smoke, 0f, 0f, 100, default, 1f);
