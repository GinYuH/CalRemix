...
{
    public class NowhereDragonDark : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            bool flag64 = Projectile.type == ModContent.ProjectileType<NowhereDragonDark>();
            if (flag64)
            {
                if (player.dead)
                {
            ...
            if (targ != null && targ.active)
            {
                ...
                if (Main.myPlayer == Projectile.owner)
                {
                    ...
                    {
                        SoundEngine.PlaySound(BetterSoundID.ItemShadowflameHexDoll2 with { Pitch = 0.5f }, Projectile.Center);
