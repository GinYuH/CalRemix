...
namespace CalRemix.Content.Projectiles.Weapons
{
    ...
    public class TotalAnnihilationProj : ModProjectile
    {
        ...
        private WhoAmI ThisIsWhoIAm
        {
            get => (WhoAmI)Projectile.ai[2];
        ...
        {
            int melee = Projectile.NewProjectile(source, Projectile.Center, Vector2.Zero, ModContent.ProjectileType<TotalAnnihilationProjOrbital>(), 0, 0, -1, Projectile.whoAmI);
            Main.projectile[melee].frame = 0;
            Main.projectile[melee].localAI[2] = 0.2f;
        }
        ...
        public override void AI()
        {
            ...
            float retractAcceleration = 2f; // How quickly the projectile will accelerate back towards the player while retracting
            float maxRetractSpeed = 66f; // The max speed the projectile will have while retracting
            ...
            float maxForcedRetractSpeed = 100f; // The max speed the projectile will have while being forced to retract
