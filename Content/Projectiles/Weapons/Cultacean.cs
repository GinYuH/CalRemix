    ...
    public class Cultacean : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (targ != null && targ.active)
            {
                ...
                {
                    Projectile.Center = Vector2.Lerp(Projectile.Center, targ.Center + targ.direction * Vector2.UnitX.RotatedBy(Projectile.whoAmI % 4 * 0.02f + MathF.Sin(Projectile.localAI[1] * 0.1f) * 0.1f) * 400, 0.1f);
