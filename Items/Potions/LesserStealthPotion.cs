...
namespace CalRemix.Items.Potions
{
    ...
    {
        public override bool CanUseItem(Player player) => player.Calamity().wearingRogueArmor && player.Calamity().rogueStealth < (player.Calamity().rogueStealthMax - (player.Calamity().rogueStealthMax * 0.1f));
